...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "Bitsend" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise Exception(_("Device not in Bitsend mode")) from e
                raise e
